---
name: helmdebugvaluesban-scan
description: Use when reviewing code for HelmDebugValuesBan findings or wiring helmdebugvaluesban into CI.
---

# HelmDebugValuesBan scan skill

When the user asks about HelmDebugValuesBan / `helmdebugvaluesban`:
