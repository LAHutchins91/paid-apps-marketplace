---
name: licensescan-scan
description: Use when reviewing code for LicenseScan findings or wiring licensescan into CI.
---

# LicenseScan scan skill

When the user asks about LicenseScan / `licensescan`:
