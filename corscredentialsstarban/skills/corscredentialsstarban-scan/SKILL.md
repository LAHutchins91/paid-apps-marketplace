---
name: corscredentialsstarban-scan
description: Use when reviewing code for CorsCredentialsStarBan findings or wiring corscredentialsstarban into CI.
---

# CorsCredentialsStarBan scan skill

When the user asks about CorsCredentialsStarBan / `corscredentialsstarban`:
