---
name: fileuploadban-scan
description: Use when reviewing code for FileUploadBan findings or wiring fileuploadban into CI.
---

# FileUploadBan scan skill

When the user asks about FileUploadBan / `fileuploadban`:
