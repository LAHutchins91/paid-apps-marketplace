...
description: Use when reviewing code for UnsignedReleaseBan findings or wiring unsignedreleaseban into CI.
---

# UnsignedReleaseBan scan skill

When the user asks about UnsignedReleaseBan / `unsignedreleaseban`:
