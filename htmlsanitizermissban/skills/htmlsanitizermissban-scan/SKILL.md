---
name: htmlsanitizermissban-scan
description: Use when reviewing code for HtmlSanitizerMissBan findings or wiring htmlsanitizermissban into CI.
---

# HtmlSanitizerMissBan scan skill

When the user asks about HtmlSanitizerMissBan / `htmlsanitizermissban`:
