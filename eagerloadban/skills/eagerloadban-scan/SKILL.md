---
name: eagerloadban-scan
description: Use when reviewing code for EagerLoadBan findings or wiring eagerloadban into CI.
---

# EagerLoadBan scan skill

When the user asks about EagerLoadBan / `eagerloadban`:
