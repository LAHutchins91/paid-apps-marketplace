---
name: jwtnonealgban-scan
description: Use when reviewing code for JwtNoneAlgBan findings or wiring jwtnonealgban into CI.
---

# JwtNoneAlgBan scan skill

When the user asks about JwtNoneAlgBan / `jwtnonealgban`:
