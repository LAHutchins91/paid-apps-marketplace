---
name: headerinjectban-scan
description: Use when reviewing code for HeaderInjectBan findings or wiring headerinjectban into CI.
---

# HeaderInjectBan scan skill

When the user asks about HeaderInjectBan / `headerinjectban`:
