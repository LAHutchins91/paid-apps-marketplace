---
name: idorguard-scan
description: Use when reviewing code for IdorGuard findings or wiring idorguard into CI.
---

# IdorGuard scan skill

When the user asks about IdorGuard / `idorguard`:
