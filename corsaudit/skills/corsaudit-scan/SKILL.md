---
name: corsaudit-scan
description: Use when reviewing code for CorsAudit (`corsaudit`) findings or wiring corsaudit into CI.
---

# CorsAudit (`corsaudit`) scan skill

When the user asks about CorsAudit (`corsaudit`) / `corsaudit`:
