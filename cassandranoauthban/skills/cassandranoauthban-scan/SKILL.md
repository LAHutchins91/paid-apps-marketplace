---
name: cassandranoauthban-scan
description: Use when reviewing code for CassandraNoAuthBan findings or wiring cassandranoauthban into CI.
---

# CassandraNoAuthBan scan skill

When the user asks about CassandraNoAuthBan / `cassandranoauthban`:
