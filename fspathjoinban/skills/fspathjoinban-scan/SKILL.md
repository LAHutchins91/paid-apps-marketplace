---
name: fspathjoinban-scan
description: Use when reviewing code for FsPathJoinBan findings or wiring fspathjoinban into CI.
---

# FsPathJoinBan scan skill

When the user asks about FsPathJoinBan / `fspathjoinban`:
