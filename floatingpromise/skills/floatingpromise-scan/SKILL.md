---
name: floatingpromise-scan
description: Use when reviewing code for FloatingPromise findings or wiring floatingpromise into CI.
---

# FloatingPromise scan skill

When the user asks about FloatingPromise / `floatingpromise`:
