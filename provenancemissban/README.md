...
Fail CI when build provenance is missing.

## What it catches

Fail CI when build provenance is missing — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Provenance Miss Ban** from the Cursor marketplace, or open this folder as a local plugin.
