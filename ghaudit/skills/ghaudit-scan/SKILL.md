---
name: ghaudit-scan
description: Use when reviewing code for ActionLint (`ghaudit`) findings or wiring ghaudit into CI.
---

# ActionLint (`ghaudit`) scan skill

When the user asks about ActionLint (`ghaudit`) / `ghaudit`:
