---
name: fetchcredsban-scan
description: Use when reviewing code for FetchCredsBan findings or wiring fetchcredsban into CI.
---

# FetchCredsBan scan skill

When the user asks about FetchCredsBan / `fetchcredsban`:
