---
name: latencybudget-scan
description: Use when reviewing code for LatencyBudget findings or wiring latencybudget into CI.
---

# LatencyBudget scan skill

When the user asks about LatencyBudget / `latencybudget`:
