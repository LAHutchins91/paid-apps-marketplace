---
name: deserialban-scan
description: Use when reviewing code for DeserialBan findings or wiring deserialban into CI.
---

# DeserialBan scan skill

When the user asks about DeserialBan / `deserialban`:
