---
name: dnsrebindurlban-scan
description: Use when reviewing code for DnsRebindUrlBan findings or wiring dnsrebindurlban into CI.
---

# DnsRebindUrlBan scan skill

When the user asks about DnsRebindUrlBan / `dnsrebindurlban`:
