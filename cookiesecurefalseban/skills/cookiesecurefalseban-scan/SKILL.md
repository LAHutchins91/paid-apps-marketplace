---
name: cookiesecurefalseban-scan
description: Use when reviewing code for CookieSecureFalseBan findings or wiring cookiesecurefalseban into CI.
---

# CookieSecureFalseBan scan skill

When the user asks about CookieSecureFalseBan / `cookiesecurefalseban`:
