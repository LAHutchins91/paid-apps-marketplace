---
name: clickhousenoauthban-scan
description: Use when reviewing code for ClickhouseNoAuthBan findings or wiring clickhousenoauthban into CI.
---

# ClickhouseNoAuthBan scan skill

When the user asks about ClickhouseNoAuthBan / `clickhousenoauthban`:
