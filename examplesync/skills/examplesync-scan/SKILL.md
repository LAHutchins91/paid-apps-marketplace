---
name: examplesync-scan
description: Use when reviewing code for ExampleSync findings or wiring examplesync into CI.
---

# ExampleSync scan skill

When the user asks about ExampleSync / `examplesync`:
