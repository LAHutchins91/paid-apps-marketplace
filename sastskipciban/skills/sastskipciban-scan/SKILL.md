---
name: sastskipciban-scan
description: Use when reviewing code for SastSkipCiBan findings or wiring sastskipciban into CI.
---

# SastSkipCiBan scan skill

When the user asks about SastSkipCiBan / `sastskipciban`:
