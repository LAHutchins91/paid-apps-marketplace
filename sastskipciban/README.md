...
Fail CI when SAST scanners are skipped — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Sast Skip CI Ban** from the Cursor marketplace, or open this folder as a local plugin.
