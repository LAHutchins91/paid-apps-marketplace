---
name: docsecrets-scan
description: Use when reviewing code for DocSecrets findings or wiring docsecrets into CI.
---

# DocSecrets scan skill

When the user asks about DocSecrets / `docsecrets`:
