---
name: httptohttpsmissban-scan
description: Use when reviewing code for HttpToHttpsMissBan findings or wiring httptohttpsmissban into CI.
---

# HttpToHttpsMissBan scan skill

When the user asks about HttpToHttpsMissBan / `httptohttpsmissban`:
