---
name: kubeexecshellban-scan
description: Use when reviewing code for KubeExecShellBan findings or wiring kubeexecshellban into CI.
---

# KubeExecShellBan scan skill

When the user asks about KubeExecShellBan / `kubeexecshellban`:
