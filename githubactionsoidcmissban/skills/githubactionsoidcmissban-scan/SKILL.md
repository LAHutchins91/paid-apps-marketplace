---
name: githubactionsoidcmissban-scan
description: Use when reviewing code for GithubActionsOidcMissBan findings or wiring githubactionsoidcmissban into CI.
---

# GithubActionsOidcMissBan scan skill

When the user asks about GithubActionsOidcMissBan / `githubactionsoidcmissban`:
