---
name: envleaklogban-scan
description: Use when reviewing code for EnvLeakLogBan findings or wiring envleaklogban into CI.
---

# EnvLeakLogBan scan skill

When the user asks about EnvLeakLogBan / `envleaklogban`:
