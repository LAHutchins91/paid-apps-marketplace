---
name: childprocessban-scan
description: Use when reviewing code for ChildProcessBan findings or wiring childprocessban into CI.
---

# ChildProcessBan scan skill

When the user asks about ChildProcessBan / `childprocessban`:
