---
name: hostheaderban-scan
description: Use when reviewing code for HostHeaderBan findings or wiring hostheaderban into CI.
---

# HostHeaderBan scan skill

When the user asks about HostHeaderBan / `hostheaderban`:
