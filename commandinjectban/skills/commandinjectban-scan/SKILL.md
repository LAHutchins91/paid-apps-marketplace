---
name: commandinjectban-scan
description: Use when reviewing code for CommandInjectBan findings or wiring commandinjectban into CI.
---

# CommandInjectBan scan skill

When the user asks about CommandInjectBan / `commandinjectban`:
