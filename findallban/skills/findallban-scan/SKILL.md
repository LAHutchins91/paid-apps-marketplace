---
name: findallban-scan
description: Use when reviewing code for FindAllBan findings or wiring findallban into CI.
---

# FindAllBan scan skill

When the user asks about FindAllBan / `findallban`:
