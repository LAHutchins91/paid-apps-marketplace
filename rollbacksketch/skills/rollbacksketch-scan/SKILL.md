---
name: rollbacksketch-scan
description: Use when reviewing code for RollbackSketch findings or wiring rollbacksketch into CI.
---

# RollbackSketch scan skill

When the user asks about RollbackSketch / `rollbacksketch`:
