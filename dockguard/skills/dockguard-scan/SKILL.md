---
name: dockguard-scan
description: Use when reviewing code for DockGuard findings or wiring dockguard into CI.
---

# DockGuard scan skill

When the user asks about DockGuard / `dockguard`:
