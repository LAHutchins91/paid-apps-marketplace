---
name: migrateunsafeban-scan
description: Use when reviewing code for MigrateUnsafeBan findings or wiring migrateunsafeban into CI.
---

# MigrateUnsafeBan scan skill

When the user asks about MigrateUnsafeBan / `migrateunsafeban`:
