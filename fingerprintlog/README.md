...
Normalize log lines into stable fingerprints.

## What it catches

Normalize log lines into stable fingerprints — surfaced as editor guidance so you can fix issues before they merge.
...
Install **FingerprintLog** from the Cursor marketplace, or open this folder as a local plugin.
