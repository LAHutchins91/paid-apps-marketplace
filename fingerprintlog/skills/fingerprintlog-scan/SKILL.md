---
name: fingerprintlog-scan
description: Use when reviewing code for FingerprintLog findings or wiring fingerprintlog into CI.
---

# FingerprintLog scan skill

When the user asks about FingerprintLog / `fingerprintlog`:
