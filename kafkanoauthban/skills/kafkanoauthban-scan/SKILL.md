---
name: kafkanoauthban-scan
description: Use when reviewing code for KafkaNoAuthBan findings or wiring kafkanoauthban into CI.
---

# KafkaNoAuthBan scan skill

When the user asks about KafkaNoAuthBan / `kafkanoauthban`:
