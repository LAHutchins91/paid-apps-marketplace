...
Fail CI when sensitive Express/Next/Fastify/Hono routes lack auth — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Missing Auth Ban** from the Cursor marketplace, or open this folder as a local plugin.
