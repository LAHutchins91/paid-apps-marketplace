---
name: transactionleakban-scan
description: Use when reviewing code for TransactionLeakBan findings or wiring transactionleakban into CI.
---

# TransactionLeakBan scan skill

When the user asks about TransactionLeakBan / `transactionleakban`:
