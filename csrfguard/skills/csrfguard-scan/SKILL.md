---
name: csrfguard-scan
description: Use when reviewing code for CsrfGuard findings or wiring csrfguard into CI.
---

# CsrfGuard scan skill

When the user asks about CsrfGuard / `csrfguard`:
