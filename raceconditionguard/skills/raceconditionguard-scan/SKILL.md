---
name: raceconditionguard-scan
description: Use when reviewing code for RaceConditionGuard findings or wiring raceconditionguard into CI.
---

# RaceConditionGuard scan skill

When the user asks about RaceConditionGuard / `raceconditionguard`:
