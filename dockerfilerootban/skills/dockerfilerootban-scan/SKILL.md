---
name: dockerfilerootban-scan
description: Use when reviewing code for DockerfileRootBan findings or wiring dockerfilerootban into CI.
---

# DockerfileRootBan scan skill

When the user asks about DockerfileRootBan / `dockerfilerootban`:
