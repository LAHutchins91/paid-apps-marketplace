...
Fail CI when HTTP clients fetch user-controlled URLs without host allowlists — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Ssrf Fetch Ban** from the Cursor marketplace, or open this folder as a local plugin.
