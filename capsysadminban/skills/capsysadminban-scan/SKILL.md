---
name: capsysadminban-scan
description: Use when reviewing code for CapSysAdminBan findings or wiring capsysadminban into CI.
---

# CapSysAdminBan scan skill

When the user asks about CapSysAdminBan / `capsysadminban`:
