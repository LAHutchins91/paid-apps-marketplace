---
name: jwtexpiryban-scan
description: Use when reviewing code for JwtExpiryBan findings or wiring jwtexpiryban into CI.
---

# JwtExpiryBan scan skill

When the user asks about JwtExpiryBan / `jwtexpiryban`:
