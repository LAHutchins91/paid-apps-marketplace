# JwtExpiryBan (Cursor plugin) — FREE forever
...
## What it does
Runs `jwtexpiryban` patterns as guidance in the IDE. Full multi-file CI gate + SARIF is Pro (outside marketplace — no paywall in this plugin).
