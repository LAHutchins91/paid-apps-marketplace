---
name: latesttagban-scan
description: Use when reviewing code for LatestTagBan findings or wiring latesttagban into CI.
---

# LatestTagBan scan skill

When the user asks about LatestTagBan / `latesttagban`:
