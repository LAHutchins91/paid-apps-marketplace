---
name: nplusoneban-scan
description: Use when reviewing code for NPlusOneBan findings or wiring nplusoneban into CI.
---

# NPlusOneBan scan skill

When the user asks about NPlusOneBan / `nplusoneban`:
