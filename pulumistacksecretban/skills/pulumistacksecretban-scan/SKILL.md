...
description: Use when reviewing code for PulumiStackSecretBan findings or wiring pulumistacksecretban into CI.
---

# PulumiStackSecretBan scan skill

When the user asks about PulumiStackSecretBan / `pulumistacksecretban`:
