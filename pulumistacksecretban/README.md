# Pulumi Stack Secret Ban

Fail CI when Pulumi stack configs leak secrets.

## What it catches

Fail CI when Pulumi stack configs leak secrets — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Pulumi Stack Secret Ban** from the Cursor marketplace, or open this folder as a local plugin.
