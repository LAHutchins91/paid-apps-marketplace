---
name: ratelimitguard-scan
description: Use when reviewing code for RateLimitGuard findings or wiring ratelimitguard into CI.
---

# RateLimitGuard scan skill

When the user asks about RateLimitGuard / `ratelimitguard`:
