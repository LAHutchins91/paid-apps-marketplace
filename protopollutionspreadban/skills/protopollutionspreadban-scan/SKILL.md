---
name: protopollutionspreadban-scan
description: Use when reviewing code for ProtoPollutionSpreadBan findings or wiring protopollutionspreadban into CI.
---

# ProtoPollutionSpreadBan scan skill

When the user asks about ProtoPollutionSpreadBan / `protopollutionspreadban`:
