---
name: cspaudit-scan
description: Use when reviewing code for CspAudit (`cspaudit`) findings or wiring cspaudit into CI.
---

# CspAudit (`cspaudit`) scan skill

When the user asks about CspAudit (`cspaudit`) / `cspaudit`:
