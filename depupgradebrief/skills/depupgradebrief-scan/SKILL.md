---
name: depupgradebrief-scan
description: Use when reviewing code for DepUpgradeBrief findings or wiring depupgradebrief into CI.
---

# DepUpgradeBrief scan skill

When the user asks about DepUpgradeBrief / `depupgradebrief`:
