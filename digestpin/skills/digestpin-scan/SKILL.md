---
name: digestpin-scan
description: Use when reviewing code for DigestPin findings or wiring digestpin into CI.
---

# DigestPin scan skill

When the user asks about DigestPin / `digestpin`:
