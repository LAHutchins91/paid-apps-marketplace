...
description: Use when reviewing code for PrivilegedContainerBan findings or wiring privilegedcontainerban into CI.
---

# PrivilegedContainerBan scan skill

When the user asks about PrivilegedContainerBan / `privilegedcontainerban`:
