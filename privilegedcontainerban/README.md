...
Fail CI when containers run privileged or with hostNetwork/hostPID — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Privileged Container Ban** from the Cursor marketplace, or open this folder as a local plugin.
