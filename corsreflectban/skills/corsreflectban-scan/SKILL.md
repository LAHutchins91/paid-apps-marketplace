---
name: corsreflectban-scan
description: Use when reviewing code for CorsReflectBan findings or wiring corsreflectban into CI.
---

# CorsReflectBan scan skill

When the user asks about CorsReflectBan / `corsreflectban`:
