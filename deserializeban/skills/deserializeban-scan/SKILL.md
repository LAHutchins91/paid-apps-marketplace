---
name: deserializeban-scan
description: Use when reviewing code for DeserializeBan findings or wiring deserializeban into CI.
---

# DeserializeBan scan skill

When the user asks about DeserializeBan / `deserializeban`:
