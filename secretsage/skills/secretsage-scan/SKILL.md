---
name: secretsage-scan
description: Use when reviewing code for SecretsAge findings or wiring secretsage into CI.
---

# SecretsAge scan skill

When the user asks about SecretsAge / `secretsage`:
