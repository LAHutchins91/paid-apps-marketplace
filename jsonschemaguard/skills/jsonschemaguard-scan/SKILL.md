---
name: jsonschemaguard-scan
description: Use when reviewing code for JsonSchemaGuard findings or wiring jsonschemaguard into CI.
---

# JsonSchemaGuard scan skill

When the user asks about JsonSchemaGuard / `jsonschemaguard`:
