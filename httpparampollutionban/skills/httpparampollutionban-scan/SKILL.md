---
name: httpparampollutionban-scan
description: Use when reviewing code for HttpParamPollutionBan findings or wiring httpparampollutionban into CI.
---

# HttpParamPollutionBan scan skill

When the user asks about HttpParamPollutionBan / `httpparampollutionban`:
