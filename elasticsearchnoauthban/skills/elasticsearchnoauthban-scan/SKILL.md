---
name: elasticsearchnoauthban-scan
description: Use when reviewing code for ElasticsearchNoAuthBan findings or wiring elasticsearchnoauthban into CI.
---

# ElasticsearchNoAuthBan scan skill

When the user asks about ElasticsearchNoAuthBan / `elasticsearchnoauthban`:
